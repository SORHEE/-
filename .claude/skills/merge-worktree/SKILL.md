...
- Always end with `Co-Authored-By`, replacing `<current-model-name>` with the name of the model currently executing this skill (e.g., "Claude Opus 4.7", "Claude Sonnet 4.6"). Never leave the placeholder literal in the final commit.
